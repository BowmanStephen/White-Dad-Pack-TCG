  ...
  first_time: [
    {
      ...
      content: 'The ultimate White Dad trading card simulator. Open packs, collect cards, and build your collection!',
      position: 'center',
      action: 'next',
    },
    {
      ...
      content: 'Click this button to open your first pack. Each pack contains 6 cards with different rarities!',
    ...
    },
    {
      ...
      content: 'Watch as each card is revealed with premium animations. Higher rarity cards have more dramatic effects!',
    ...
    },
    {
      ...
      content: 'All opened cards are saved to your collection automatically. Click "My Collection" to view them anytime!',
      target: '[data-tutorial="collection-link"]',
      position: 'bottom',
      action: 'next',
    },
    {
      id: 'rarity_info',
      title: 'Card Rarities',
      content: 'Cards range from Common (grey) to Mythic (pink). Higher rarity cards have better stats and cooler effects!',
      position: 'center',
      action: 'next',
    },
    {
      ...
      content: 'You\'ve completed the tutorial! Open more packs, explore your collection, and check out battles and trading.',
      position: 'center',
      action: 'next',
    },
  ],
