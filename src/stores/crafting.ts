...
export const CRAFTING_RECIPES: Record<string, CraftingRecipe> = {
  ...
  uncommon_to_rare: {
    ...
    description: 'Combine 5 Uncommon cards for a chance to create 1 Rare card. 100% success rate.',
  ...
  rare_to_epic: {
    id: 'rare_to_epic',
    name: 'Epic Fusion',
    description: 'Combine 5 Rare cards for a 50% chance to create 1 Epic card. On failure, 60% of materials are returned.',
    inputRarity: 'rare',
    inputCount: 5,
    outputRarity: 'epic',
    outputCount: 1,
  ...
  epic_to_legendary: {
    ...
    description: 'Combine 5 Epic cards for a 30% chance to create 1 Legendary card. On failure, 40% of materials are returned.',
    inputRarity: 'epic',
    inputCount: 5,
