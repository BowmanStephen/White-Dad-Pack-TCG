...
export function getTypeAdvantage(attacker: DadType, defender: DadType): number {
  ...
  const advantages: Record<DadType, DadType[]> = {
    ...
    BBQ_DAD: ['COUCH_DAD', 'CHEF_DAD', 'COUCH_CUMMANDER', 'CHEF_CUMSTERS'],
    FIX_IT_DAD: ['CAR_DAD', 'WAREHOUSE_DAD', 'CAR_COCK', 'WAREHOUSE_WANKERS'],
    GOLF_DAD: ['COOL_DAD', 'COACH_DAD', 'COOL_CUCKS', 'COACH_CUMSTERS'],
    COUCH_DAD: ['OFFICE_DAD', 'COACH_DAD', 'OFFICE_ORGASMS', 'COACH_CUMSTERS'],
    LAWN_DAD: ['FASHION_DAD', 'COUCH_DAD', 'FASHION_FUCK', 'COUCH_CUMMANDER'],
    CAR_DAD: ['FIX_IT_DAD', 'VINTAGE_DAD', 'FIX_IT_FUCKBOY', 'VINTAGE_VAGABONDS'],
    OFFICE_DAD: ['COUCH_DAD', 'TECH_DAD', 'COUCH_CUMMANDER', 'TECH_TWATS'],
    COOL_DAD: ['GOLF_DAD', 'VINTAGE_DAD', 'GOLF_GONAD', 'VINTAGE_VAGABONDS'],
    COACH_DAD: ['COUCH_DAD', 'LAWN_DAD', 'COUCH_CUMMANDER', 'LAWN_LUNATIC'],
    CHEF_DAD: ['BBQ_DAD', 'COUCH_DAD', 'BBQ_DICKTATOR', 'COUCH_CUMMANDER'],
    HOLIDAY_DAD: ['LAWN_DAD', 'FASHION_DAD', 'LAWN_LUNATIC', 'FASHION_FUCK'],
    WAREHOUSE_DAD: ['CAR_DAD', 'FIX_IT_DAD', 'CAR_COCK', 'FIX_IT_FUCKBOY'],
    VINTAGE_DAD: ['TECH_DAD', 'COOL_DAD', 'TECH_TWATS', 'COOL_CUCKS'],
    FASHION_DAD: ['COOL_DAD', 'OFFICE_DAD', 'COOL_CUCKS', 'OFFICE_ORGASMS'],
    TECH_DAD: ['OFFICE_DAD', 'VINTAGE_DAD', 'OFFICE_ORGASMS', 'VINTAGE_VAGABONDS'],
    // Unhinged names (Season 2+) - same advantages as clean names
    BBQ_DICKTATOR: ['COUCH_DAD', 'CHEF_DAD', 'COUCH_CUMMANDER', 'CHEF_CUMSTERS'],
    FIX_IT_FUCKBOY: ['CAR_DAD', 'WAREHOUSE_DAD', 'CAR_COCK', 'WAREHOUSE_WANKERS'],
    GOLF_GONAD: ['COOL_DAD', 'COACH_DAD', 'COOL_CUCKS', 'COACH_CUMSTERS'],
    COUCH_CUMMANDER: ['OFFICE_DAD', 'COACH_DAD', 'OFFICE_ORGASMS', 'COACH_CUMSTERS'],
    LAWN_LUNATIC: ['FASHION_DAD', 'COUCH_DAD', 'FASHION_FUCK', 'COUCH_CUMMANDER'],
    CAR_COCK: ['FIX_IT_DAD', 'VINTAGE_DAD', 'FIX_IT_FUCKBOY', 'VINTAGE_VAGABONDS'],
    OFFICE_ORGASMS: ['COUCH_DAD', 'TECH_DAD', 'COUCH_CUMMANDER', 'TECH_TWATS'],
    COOL_CUCKS: ['GOLF_DAD', 'VINTAGE_DAD', 'GOLF_GONAD', 'VINTAGE_VAGABONDS'],
    COACH_CUMSTERS: ['COUCH_DAD', 'LAWN_DAD', 'COUCH_CUMMANDER', 'LAWN_LUNATIC'],
    CHEF_CUMSTERS: ['BBQ_DAD', 'COUCH_DAD', 'BBQ_DICKTATOR', 'COUCH_CUMMANDER'],
    HOLIDAY_HORNDOGS: ['LAWN_DAD', 'FASHION_DAD', 'LAWN_LUNATIC', 'FASHION_FUCK'],
    WAREHOUSE_WANKERS: ['CAR_DAD', 'FIX_IT_DAD', 'CAR_COCK', 'FIX_IT_FUCKBOY'],
    VINTAGE_VAGABONDS: ['TECH_DAD', 'COOL_DAD', 'TECH_TWATS', 'COOL_CUCKS'],
    FASHION_FUCK: ['COOL_DAD', 'OFFICE_DAD', 'COOL_CUCKS', 'OFFICE_ORGASMS'],
    TECH_TWATS: ['OFFICE_DAD', 'VINTAGE_DAD', 'OFFICE_ORGASMS', 'VINTAGE_VAGABONDS'],
    // Extended Archetypes
    SUBURBAN_SPY: ['NEIGHBORHOOD_NOSY', 'OFFICE_DAD', 'OFFICE_ORGASMS'],
    GAMER_GIZZARDS: ['COUCH_DAD', 'TECH_DAD', 'COUCH_CUMMANDER', 'TECH_TWATS'],
    PREPPER_PENIS: ['SUBURBAN_SOCIALITE', 'HOLIDAY_DAD', 'HOLIDAY_HORNDOGS'],
    BBQ_BRAWLER: ['BBQ_DAD', 'CHEF_DAD', 'BBQ_DICKTATOR', 'CHEF_CUMSTERS'],
    SUBURBAN_SOCIALITE: ['FASHION_DAD', 'COOL_DAD', 'FASHION_FUCK', 'COOL_CUCKS'],
    NEIGHBORHOOD_NOSY: ['SUBURBAN_SPY', 'OFFICE_DAD', 'OFFICE_ORGASMS'],
    // Crossover Events - neutral advantages
    DUNE_DESERT: ['LAWN_DAD', 'LAWN_LUNATIC'],
    MARVEL_MASH: ['COOL_DAD', 'COOL_CUCKS'],
    STAR_WARS_SWINGER: ['TECH_DAD', 'TECH_TWATS'],
    MCDONALDS_MEAT: ['CHEF_DAD', 'CHEF_CUMSTERS'],
    POTTER_PERVERT: ['VINTAGE_DAD', 'VINTAGE_VAGABONDS'],
    FORTNITE_FUCKER: ['GAMER_GIZZARDS', 'COUCH_DAD', 'COUCH_CUMMANDER'],
    // Family Variants
    SON_SPAWNS: ['DAUGHTER_DINGBATS'],
    DAUGHTER_DINGBATS: ['SON_SPAWNS'],
    UNCLE_UPROARS: ['HOLIDAY_DAD', 'HOLIDAY_HORNDOGS'],
