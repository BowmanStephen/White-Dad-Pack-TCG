...
let { error, originalError, onClose }: Props = $props();
...
const userAgent = $derived.by(() => (typeof navigator !== 'undefined' ? navigator.userAgent : ''));
const url = $derived.by(() => (typeof window !== 'undefined' ? window.location.href : ''));
const timestamp = $derived.by(() => new Date(error.timestamp).toISOString());
...
<div class="error-report-backdrop">
  ...
  >
    <div class="error-report-header">
      ...
      <button class="close-btn" onclick={onClose} aria-label="Close modal" type="button">
        ×
      </button>
    </div>
      ...
      <div class="error-report-content">
        ...
        <div class="error-details">
          ...
          <div class="detail-row">
            ...
            <button class="copy-btn" onclick={copyErrorId} aria-label="Copy error ID"> 📋 </button>
          </div>
          <div class="detail-row">
