    ...
    <div class="modal-container">
      ...
      <div class="modal-content">
        ...
        <div class="card-display">
          <div
            class="card-image"
            style="--rarity-color: {RARITY_CONFIG[card.rarity]
              .color}; --rarity-glow: {RARITY_CONFIG[card.rarity].glowColor};"
          >
            <!-- Card Background -->
        ...
        <div class="info-panel">
          ...
          <div class="details-section">
            ...
            <div class="detail-grid">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value"
                  >#{card.cardNumber.toString().padStart(3, '0')}/{card.totalInSeries}</span
                >
              </div>
          ...
          {#if hasCardStats(card.type)}
            <div class="stats-section">
              ...
              <EnhancedCardStats {card} showComparison={false} showRatings={true} />
            </div>
          {:else}
          ...
          <div class="actions-section">
            {#if ownedCount > 0}
              <div class="deck-action-container">
                ...
                <!-- Deck Selector Dropdown (stubbed - feature archived) -->
                {#if showDeckSelector}
                  <div class="deck-selector-dropdown">
                    <div class="deck-selector-header">
                      <span>Select a deck</span>
                      <button class="deck-selector-close" onclick={closeDeckSelector} type="button"
                        >✕</button
                      >
                    </div>
                    <div class="deck-selector-list">
                      <p class="deck-selector-message">Deck building feature coming soon!</p>
                    </div>
                  </div>
                {/if}
