...
describe('Crafting System - PACK-051', () => {
  ...
  describe('verifyCraftingSuccessRate', () => {
    it('should have appropriate success rates for different recipes', () => {
      ...
      expect(CRAFTING_RECIPES.uncommon_to_rare.successRate).toBe(1.0);
      expect(CRAFTING_RECIPES.rare_to_epic.successRate).toBe(0.5);
      expect(CRAFTING_RECIPES.epic_to_legendary.successRate).toBe(0.3);
    ...
    it('should generate correct rarity on successful craft', async () => {
      ...
      const inputCards = Array.from({ length: 5 }, () => createMockCard('uncommon'));
  ...
  describe('verifyCraftingFailureReturn', () => {
    ...
    it('should not have failReturnRate for guaranteed recipes', () => {
      const guaranteedRecipes = ['common_to_uncommon', 'uncommon_to_rare'];
    ...
    it('should have appropriate return rates for each recipe tier', () => {
      ...
      expect(CRAFTING_RECIPES.epic_to_legendary.failReturnRate).toBe(0.4);
